# `@geowealth/tests-trading`

GeoWealth E2E tests for the **Trading** team.
...
3. Tag with `@smoke` or `@regression` plus `@trading`.
4. Use the framework's Page Objects and fixtures; never call `@playwright/test` directly.

## Ownership

This package is owned by the Trading team. Cross-team Page Objects belong in `@geowealth/e2e-framework`, not here. See Section 4.2.2 of `docs/OFFICIAL-FRAMEWORK-PROPOSAL.md` for the promotion rule.
