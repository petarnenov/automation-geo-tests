...
> - Node 24 инсталиран (match-ва `.nvmrc`).
...
|---|---|---|
| Node.js | `24.x` (declared в `package.json` `engines` и `.nvmrc`) | Current release line; изисква се от Playwright 1.59+. |
...
**Deliverables.**
- Workspace root: `package.json` с workspaces и Node 24, `package-lock.json`, `tsconfig.base.json`, `.env.example`, `.nvmrc`, `CODEOWNERS`, `.eslintrc.legacy-areas.json`.
