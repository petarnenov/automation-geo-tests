...
- [ ] All six areas above completed except `auto-link`, which is explicitly handed off to Phase 5.
...
| D-04 | Repository topology (standalone vs `~/nodejs/geowealth/e2e`) | SUPERSEDED by D-24 | — | — | — | — |
